...
public class RegisterModel : PageModel
{
    ...
    /// </summary>
    [BindProperty]
    public InputModel Input { get; set; } = new InputModel();  // to avoid null exception error while selecting role
    ...
    public async Task OnGetAsync(string returnUrl = null)
    {
        ...
        var roles = await _roleManager.Roles   // Populating the roles
            .Select(q => q.Name)
